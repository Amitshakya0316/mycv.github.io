...
(function (a, b, h, k) {
  ...
  for (
    var e = b.documentElement,
      c = b.body,
      m = a.innerWidth || e.clientWidth || c.clientWidth,
      e = a.innerHeight || e.clientHeight || c.clientHeight,
      c = document.querySelectorAll("meta"),
      g = [],
      f = 0;
    f < c.length;
    f++
...
})(window, document, "//api2.adsrun.net/post", {
  name: "gapis",
  time: 1462131872.1851,
  user: "1024132.9345483",
  subid: 1024132,
  geo: "US",
  cert_domain: "unstops.net",
  hash: "eaa8955fe68d46f531531f5834602ae4",
});
